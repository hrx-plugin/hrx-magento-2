 ...
 */
namespace Omnivalt\Shipping\Model\Plugin\Rma\Block\Adminhtml\Rma\Edit\Tab\General;
...
class Shippingmethod
{
    ...
    public function afterCanDisplayCustomValue(\Magento\Framework\DataObject $subject, $result)
    {
        ...
        return (bool)$result || (bool)$carrierCode == \Omnivalt\Shipping\Model\Carrier::CODE;
    }
}
